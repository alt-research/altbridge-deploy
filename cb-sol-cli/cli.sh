...
function deploy_rollup() {
	...
	_GL=${GAS_LIMIT_DEPLOY} _call deploy --bridge --rollupHandler --rollupExample --chainId ${DOMAIN_ID} --relayerThreshold ${THRESHOLD} --relayers ${RELAYERS} --expiry 10000000
}
